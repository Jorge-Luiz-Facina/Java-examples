...
import com.spi.service.one.client.ExternalClient;
import com.spi.service.one.client.dto.InfoResponseDTO;
import com.spi.service.one.client.dto.UserLoginResponseDTO;
import com.spi.service.one.adapter.UserAdapter;
import com.spi.service.one.enums.ExceptionEnum;
import com.spi.service.one.exception.CustomException;
import com.spi.service.one.log.LoggingFilter;
...
public class ServiceOneStorageProvider
    ...
    private static final Logger LOG
            = Logger.getLogger(ServiceOneStorageProvider.class.getName());

    public ServiceOneStorageProvider(KeycloakSession session, ComponentModel model) {
